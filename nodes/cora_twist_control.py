...
if __name__ == '__main__':
    ...
    # Setup publisher
    node.left_publisher = rospy.Publisher('/cusv/thrusters/left_thrust_cmd',Float32,queue_size=1)
    node.right_publisher = rospy.Publisher('/cusv/thrusters/right_thrust_cmd',Float32,queue_size=1)
